      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 animate-fade-in">
          ...
          <div className="flex gap-2 overflow-x-auto pb-2">
            {["Hôm nay", "7 ngày", "30 ngày", "6 tháng", "1 năm"].map(
              (period, idx) => (
                <button
                  key={idx}
          ...
          {stats.map((item, index) => {
            ...
            return (
              <div
                ...
                } bg-white rounded-2xl p-6 border border-slate-200 hover:shadow-xl transition-all duration-300 hover:scale-105 ${
                  item.shadowColor
                } shadow-lg group`}
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div
                    className={`${item.color} p-3 rounded-xl shadow-md group-hover:scale-110 transition-transform duration-300`}
                  >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-300">
            <div className="mb-6">
              ...
              <p className="text-slate-600 text-sm">
                5 khách hàng có doanh thu cao nhất
              </p>
            </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-300">
          <div className="mb-6">
            ...
            <p className="text-slate-600 text-sm">
              Các giao dịch và thay đổi mới nhất
            </p>
          </div>
